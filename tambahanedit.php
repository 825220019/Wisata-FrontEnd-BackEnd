...
<?php
	...
	if (isset($_POST['Ubah']))
	{
		...
		mysqli_query($connection, "update cindy set cindyNEGARA='$negaracindy', destinasiID='$kodedestinasi'
	...
	$kodecindy = $_GET["ubah"];
	$editcindy = mysqli_query($connection, "select * from cindy
	where cindyID= '$kodecindy'");
	$rowedit = mysqli_fetch_array($editcindy);
	
	$editdestinasi = mysqli_query($connection, "select * from cindy, destinasi
	where cindyID = '$kodecindy'and cindy.destinasiID = destinasi.destinasiID");
      ...
      <form method="POST">
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				value="<?php echo $rowedit["cindyID"]?>">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				value="<?php echo $rowedit["cindyNEGARA"]?>">
			</div>
		</div>
