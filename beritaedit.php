...
<?php
	...
	if (isset($_POST['Edit']))
	{
		...
		mysqli_query($connection, "update berita set beritajudul='$beritanama', beritainti='$beritainti',
		penulis='$beritapenulis', penerbit='$beritapenerbit', tanggalterbit='$beritatanggal'
		, destinasiID='$kodedestinasi'
		WHERE beritaID = '$kodeberita'");
		header ("location:beritainput.php");
	}
	$datadestinasi = mysqli_query($connection, "select * from berita");
      ...
      <form method="POST">
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				value="<?php echo $rowedit["beritaID"]?>">
			</div>
		</div>
