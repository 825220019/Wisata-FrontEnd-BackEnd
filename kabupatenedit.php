...
<?php 
	...
	if(isset($_POST['Ubah']))
	{
		...
		if(($ekstensifile == "png") or ($ekstensifile == "PNG"))
		{
			...
			mysqli_query ($connection, "UPDATE kabupaten SET kabupatenNAMA ='$namakabupaten',
			kabupatenALAMAT ='$alamatkabupaten',kabupatenKET ='$keterangankabupaten',
			kabupatenFOTOICON = '$nama', kabupatenFOTOICONKET ='$ketfotokabupaten'
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				value="<?php echo $rowedit["kabupatenKODE"]?>">
			</div>
		</div>
