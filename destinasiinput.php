...
<?php
	...
	{
		if (isset($_REQUEST['kodedestinasi']))
		{
			$kodedestinasi = $_REQUEST['kodedestinasi'];
		}
		...
		mysqli_query($connection, "insert into destinasi values ('$kodedestinasi', '$destinasinama', 
		'$destinasialamat', '$kodekategori', '$kodearea')");
		header("location:destinasiinput.php");
	}
	...
	<div class="jumbotron jumbotron-fluid" style="background-color:#ACBCFF; color: white;">
      ...
      <form method="POST">
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="kodedestinasi" name="kodedestinasi"
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="destinasinama" name="destinasinama"
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="destinasialamat" name="destinasialamat"
